...
void bxdf_HGScatter::Synchronize( RixContext& ctx, RixSCSyncMsg syncMsg, const RixParameterList* pList )
{
    ...
    sg_HGScatter_LS = RixBXLookupLobeByName( ctx,
...
class BxdfClosure : public RixBxdf
{
  ...
  public:
    ...
    #include "bxdf/HGScatterSampling.inl"
};
